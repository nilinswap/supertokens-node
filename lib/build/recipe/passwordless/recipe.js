        ...
        this.handleAPIRequest = (id, req, res, _, __) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.CONSUME_CODE_API) {
                    return yield (0, consumeCode_1.default)(this.apiImpl, options);
                } else if (id === constants_1.CREATE_CODE_API) {
                    return yield (0, createCode_1.default)(this.apiImpl, options);
                    ...
                    return yield (0, phoneNumberExists_1.default)(this.apiImpl, options);
                } else {
                    return yield (0, resendCode_1.default)(this.apiImpl, options);
                }
            });
