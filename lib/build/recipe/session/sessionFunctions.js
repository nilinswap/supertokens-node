    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const key of handShakeInfo.getJwtSigningPublicKeyList()) {
            try {
                 ...
                 */
                accessTokenInfo = yield (0, accessToken_1.getInfoFromAccessToken)(
                    accessToken,
                    key.publicKey,
                 ...
                 * error to the user
                 */
                const timeCreated = (0, utils_2.handleNonErrorInstance)(err, (err) =>
                    __awaiter(this, void 0, void 0, function* () {
                        ...
                        let payload;
                        try {
                            payload = (0, jwt_1.getPayloadWithoutVerifiying)(accessToken);
                        } catch (_) {
                            throw err;
                        }
