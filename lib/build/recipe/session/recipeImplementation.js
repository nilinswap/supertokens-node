...
const utils_3 = require("../session/utils");
class HandshakeInfo {
    constructor(
        antiCsrf,
    ...
    let obj = {
        createNewSession: function ({ res, userId, accessTokenPayload = {}, sessionData = {} }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                (0, utils_1.attachCreateOrRefreshSessionResponseToExpressRes)(config, res, response);
        ...
        getSession: function ({ req, res, options }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                (0, logger_1.logDebugMessage)("getSession: rid in header: " + (0, utils_2.frontendHasInterceptor)(req));
                (0, logger_1.logDebugMessage)("getSession: request method: " + req.getMethod());
                let doAntiCsrfCheck = options !== undefined ? options.antiCsrfCheck : undefined;
                let idRefreshToken = (0, cookieAndHeaders_1.getIdRefreshTokenFromCookie)(req);
                ...
                let accessToken = (0, cookieAndHeaders_1.getAccessTokenFromCookie)(req);
                if (accessToken === undefined) {
                    ...
                    if (
                        ...
                        (0, utils_2.frontendHasInterceptor)(req) ||
                        (0, utils_2.normaliseHttpMethod)(req.getMethod()) === "get"
                    ) {
                        (0, logger_1.logDebugMessage)(
                ...
                try {
                    ...
                    let response = yield SessionFunctions.getSession(
                        ...
                        antiCsrfToken,
                        doAntiCsrfCheck,
                        (0, cookieAndHeaders_1.getRidFromHeader)(req) !== undefined
                    );
                    if (response.accessToken !== undefined) {
                        ...
                        (0, cookieAndHeaders_1.attachAccessTokenToCookie)(
                            config,
                            res,
                            response.accessToken.token,
                            response.accessToken.expiry
                    ...
                    return (0, utils_3.handleNonErrorInstance)(err, (err) => {
                        if (err.type === error_1.default.UNAUTHORISED) {
                            (0, logger_1.logDebugMessage)(
                                "getSession: Clearing cookies because of UNAUTHORISED response"
                            );
                            (0, cookieAndHeaders_1.clearSessionFromCookie)(config, res);
                        }
                        throw err;
                    });
                }
        ...
        refreshSession: function ({ req, res }) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                let inputIdRefreshToken = (0, cookieAndHeaders_1.getIdRefreshTokenFromCookie)(req);
                ...
                try {
                    let inputRefreshToken = (0, cookieAndHeaders_1.getRefreshTokenFromCookie)(req);
