...
class SessionRecipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config) {
        ...
        this.handleAPIRequest = (id, req, res, path, method) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.REFRESH_API_PATH) {
                    return yield (0, refresh_1.default)(this.apiImpl, options);
                } else if (id === constants_1.SIGNOUT_API_PATH) {
                    return yield (0, signout_1.default)(this.apiImpl, options);
        ...
        (0, logger_1.logDebugMessage)("session init: antiCsrf: " + this.config.antiCsrf);
        (0, logger_1.logDebugMessage)("session init: cookieDomain: " + this.config.cookieDomain);
        (0, logger_1.logDebugMessage)("session init: cookieSameSite: " + this.config.cookieSameSite);
