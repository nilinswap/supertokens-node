...
class Recipe extends recipeModule_1.default {
    constructor(recipeId, appInfo, isInServerlessEnv, config, recipes, ingredients) {
        ...
        let emailPasswordRecipeImplementation = (0, emailPasswordRecipeImplementation_1.default)(
                ...
                : new recipe_2.default(
                      ...
                      isInServerlessEnv,
                      {
                          override: {
                              ...
                              apis: (_) => {
                                  return (0, emailPasswordAPIImplementation_1.default)(this.apiImpl);
                              },
                          },
                          signUpFeature: {
                ...
                recipes.thirdPartyInstance !== undefined
                    ...
                    : new recipe_3.default(
                          ...
                          isInServerlessEnv,
                          {
                              override: {
                                  functions: (_) => {
                                      return (0, thirdPartyRecipeImplementation_1.default)(this.recipeInterfaceImpl);
                                  },
                                  apis: (_) => {
                                      return (0, thirdPartyAPIImplementation_1.default)(this.apiImpl);
                                  },
                              },
                              signInAndUpFeature: {
