...
exports.createAndSendCustomEmail = exports.getEmailVerificationURL = void 0;
    ...
    return (user, emailVerifyURLWithToken) =>
        __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                (0, logger_1.logDebugMessage)(`Email sent to ${user.email}`);
            } catch (error) {
                (0, logger_1.logDebugMessage)("Error sending verification email");
