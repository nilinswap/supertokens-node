        ...
        this.handleAPIRequest = (id, req, res, path, method) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.SIGN_IN_UP_API) {
                    return yield (0, signinup_1.default)(this.apiImpl, options);
                } else if (id === constants_1.AUTHORISATION_API) {
                    return yield (0, authorisationUrl_1.default)(this.apiImpl, options);
                } else if (id === constants_1.APPLE_REDIRECT_HANDLER) {
                    return yield (0, appleRedirect_1.default)(this.apiImpl, options);
                } else {
