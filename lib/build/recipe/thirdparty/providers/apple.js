...
const utils_1 = require("../../../recipe/session/utils");
function Apple(config) {
        ...
        return (0, jsonwebtoken_1.sign)(
            {
                ...
                sub: (0, implementation_1.getActualClientIdFromDevelopmentClientId)(clientId),
            },
            privateKey.replace(/\\n/g, "\n"),
    ...
    try {
        ...
        (0, utils_1.handleNonErrorInstance)(error, (error) =>
    ...
    function get(redirectURI, authCodeFromRequest) {
        ...
        function getProfileInfo(accessTokenAPIResponse) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const payload = yield (0, verify_apple_id_token_1.default)({
                    idToken: accessTokenAPIResponse.id_token,
                    clientId: (0, implementation_1.getActualClientIdFromDevelopmentClientId)(config.clientId),
                });
                if (payload === null) {
