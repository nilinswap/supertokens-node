...
exports.defaultEmailValidator = exports.defaultPasswordValidator = exports.normaliseSignUpFormFields = exports.validateAndNormaliseEmailVerificationConfig = exports.validateAndNormaliseUserInput = void 0;
...
function validateAndNormaliseResetPasswordUsingTokenConfig(_, appInfo, signUpConfig, config) {
    ...
    let getResetPasswordURL =
        config === undefined || config.getResetPasswordURL === undefined
            ? (0, passwordResetFunctions_1.getResetPasswordURL)(appInfo)
