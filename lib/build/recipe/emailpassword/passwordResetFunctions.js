...
exports.createAndSendCustomEmail = exports.getResetPasswordURL = void 0;
    ...
    return (user, passwordResetURLWithToken) =>
        __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                (0, logger_1.logDebugMessage)(`Password reset email sent to ${user.email}`);
            } catch (error) {
                (0, logger_1.logDebugMessage)("Error sending password reset email");
                if (axios_1.default.isAxiosError(error)) {
                    const err = error;
                    if (err.response) {
                        (0, logger_1.logDebugMessage)(`Error status: ${err.response.status}`);
                        (0, logger_1.logDebugMessage)(`Error response: ${JSON.stringify(err.response.data)}`);
                    } else {
                        (0, logger_1.logDebugMessage)(`Error: ${err.message}`);
                    }
                } else {
