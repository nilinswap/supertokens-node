        ...
        this.handleAPIRequest = (id, req, res, path, method) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (id === constants_1.SIGN_UP_API) {
                    return yield (0, signup_1.default)(this.apiImpl, options);
                } else if (id === constants_1.SIGN_IN_API) {
                    return yield (0, signin_1.default)(this.apiImpl, options);
                } else if (id === constants_1.GENERATE_PASSWORD_RESET_TOKEN_API) {
                    return yield (0, generatePasswordResetToken_1.default)(this.apiImpl, options);
                } else if (id === constants_1.PASSWORD_RESET_API) {
                    return yield (0, passwordReset_1.default)(this.apiImpl, options);
                } else if (id === constants_1.SIGNUP_EMAIL_EXISTS_API) {
                    return yield (0, emailExists_1.default)(this.apiImpl, options);
                } else {
