        ...
        this.getFormData = () =>
            __awaiter(this, void 0, void 0, function* () {
                if (!this.formDataParserChecked) {
                    yield (0, utils_2.assertFormDataBodyParserHasBeenUsedForExpressLikeRequest)(this.request);
        ...
        this.getJSONBody = () =>
            __awaiter(this, void 0, void 0, function* () {
                if (!this.parserChecked) {
                    yield (0, utils_2.assertThatBodyParserHasBeenUsedForExpressLikeRequest)(
                        this.getMethod(),
                        this.request
                    );
