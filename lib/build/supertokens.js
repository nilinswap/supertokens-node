    ...
    constructor(config) {
        ...
        this.deleteUser = (input) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if ((0, utils_1.maxVersion)("2.10", cdiVersion) === cdiVersion) {
        ...
        this.middleware = (request, response) =>
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (requestRID !== undefined) {
                    ...
                    (0, logger_1.logDebugMessage)("middleware: Matched with recipe ID: " + matchedRecipe.getRecipeId());
                    ...
                    (0, logger_1.logDebugMessage)("middleware: Request being handled by recipe. ID is: " + id);
            ...
            __awaiter(this, void 0, void 0, function* () {
                ...
                if (error_1.default.isErrorFromSuperTokens(err)) {
                    ...
                    if (err.type === error_1.default.BAD_INPUT_ERROR) {
                        ...
                        return (0, utils_1.sendNon200Response)(response, err.message, 400);
                    }
                    for (let i = 0; i < this.recipeModules.length; i++) {
                        (0, logger_1.logDebugMessage)(
        ...
        (0, logger_1.logDebugMessage)("appInfo: " + JSON.stringify(config.appInfo));
